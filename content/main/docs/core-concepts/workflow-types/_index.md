...
##### Examples:
- [Greeting](https://github.com/rhdhoperator/serverless-workflows/blob/main/workflows/greeting/greeting.sw.yaml)
- [Ticket Escalation](https://github.com/rhdhoperator/serverless-workflows/blob/main/workflows/escalation/ticketEscalation.sw.yaml)
- [Move2Kube](https://github.com/rhdhoperator/serverless-workflows/blob/main/workflows/move2kube/m2k.sw.yml)
...
##### Examples:
- [MTA](https://github.com/rhdhoperator/serverless-workflows/blob/main/workflows/mta/mta.sw.yaml)
