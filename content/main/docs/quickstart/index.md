...
2. **Install a sample workflow**:
   Follow the [installation instructions for the greetings workflow](https://github.com/rhdhoperator/serverless-workflows-config/blob/main/docs/main/greeting/README.md).
