...
The [following script](https://github.com/rhdhoperator/serverless-workflows/blob/main/hack/filter-openapi-specs.py) can be used to extract reuced openAPI documents from larger ones.
